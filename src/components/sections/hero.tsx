      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 w-full sm:w-auto px-4 sm:px-0">
          <Button
            asChild
            size="lg"
            className="h-12 md:h-14 w-full sm:w-auto text-base md:text-lg group relative rounded-xl px-6 md:px-8 font-medium shadow-lg transition-all duration-300 bg-foreground text-background hover:bg-foreground"
          >
            <a
