...
export function Header() {
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/" className="flex items-center gap-3 text-lg font-semibold tracking-tight px-3 py-1 -mx-3 -my-2 rounded-xl hover:bg-foreground/10 transition-all">
          <Image
            src="/favicon.png"
            alt="Stasis Logo"
            width={32}
        ...
        <div className="hidden md:flex items-center gap-2 text-sm font-medium text-muted-foreground">
          <Link href="/#features" className="px-3 py-2 rounded-xl hover:bg-foreground/10 hover:text-foreground transition-all">
            Features
          </Link>
          <a
            ...
            className="px-3 py-2 rounded-xl hover:bg-foreground/10 hover:text-foreground transition-all"
          >
            Documentation
          </a>
          <Link
