          ...
          >
            <div className="flex items-center justify-between w-full">
              ...
              <div className="hidden md:flex items-center gap-2 text-sm font-medium text-muted-foreground z-10">
                ...
                <Button
                  className="group relative rounded-xl px-4 ml-2 font-medium shadow-sm transition-all duration-300 bg-foreground text-background hover:bg-foreground cursor-pointer flex items-center justify-center gap-1.5"
              ...
              {isMobileMenuOpen && (
                ...
                >
                  <div className="flex flex-col gap-2 pt-4">
                    ...
                    <Button
                      className="w-full mt-2 rounded-xl py-6 font-medium shadow-sm transition-all duration-300 bg-foreground text-background hover:bg-foreground/90 cursor-pointer flex items-center justify-center gap-4"
                      onClick={() => {
                        setIsMobileMenuOpen(false);
